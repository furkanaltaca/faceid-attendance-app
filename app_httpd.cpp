  ...
  if (align_face(net_boxes, image_matrix, aligned_face) == ESP_OK) {
    ...
    if (is_enrolling == 1) {
      ...
      if (left_sample_face == 0) {
        ...
        faceId = id_list.tail - 1;

        // float *face_data = aligned_face->embedding;
        // size_t face_data_length = aligned_face->w * aligned_face->h * 3;  // 3 kanallı renkli bir resim olduğu varsayımıyla

        // saveFaceData(face_data, face_data_length);
      }
    } else {
